...
{
    public class CloaneableTest
    {
        [Fact, Trait("Category", "Prototype")]
        public void Cloneable_Returns_Copy()
        {
        ...
        [Fact, Trait("Category", "Prototype")]
        public void Cloneable_Deep_Keep_Origin_Copy_If_Changed()
        {
            var tv = GetTelevision();
        ...
        [Fact, Trait("Category", "Prototype")]
        public void Cloneable_Shallow_Does_Not_Keep_Origin_Copy_If_Changed()
        {
            var tv = GetTelevision();
